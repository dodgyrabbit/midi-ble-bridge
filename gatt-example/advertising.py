...
class Advertisement(dbus.service.Object):
    ...
    def get_properties(self):
        ...
        if self.data is not None:
            properties['Data'] = [0x9, dbus.Byte('T'), dbus.Byte('e'), dbus.Byte('s'), dbus.Byte('t')]
            print('Added Data property')
...
class TestAdvertisement(Advertisement):
    def __init__(self, bus, index):
        ...
        #self.add_data('9999', [0x00, 0x01, 0x02, 0x03, 0x04])
        self.add_local_name('PIETER')
        #self.add_service_uuid('7772E5DB-3868-4112-A1A9-F2669D106BF3')
